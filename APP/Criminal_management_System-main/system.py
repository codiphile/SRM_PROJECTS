...
class Criminal:
    def __init__(self,root):
        ...
        no.grid(row=0, column=1, pady=5, padx=5, sticky=W)
        ...
        #Add Button
        btn_add=Button(button_frame,command=self.add_data,text='Save',font=('arial',13,'bold'),width=14,bg='blue',fg='black')
        btn_add.grid(row=0,column=0,padx=3,pady=5)

        #Update Button
        btn_update=Button(button_frame,command=self.update_data,text='Update',font=('arial',13,'bold'),width=14,bg='blue',fg='black')
        btn_update.grid(row=0,column=1,padx=3,pady=5)

        #Delete Button
        btn_delete=Button(button_frame,command=self.delete_data ,text='Delete',font=('arial',13,'bold'),width=14,bg='blue',fg='black')
        btn_delete.grid(row=0,column=2,padx=3,pady=5)

        #Clear Button
        btn_clear=Button(button_frame,command=self.clear_data, text='Clear',font=('arial',13,'bold'),width=14,bg='blue',fg='black')
    ...
    def add_data(self):
        if self.var_case_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host='localhost', username='root',password='Unstoppable@1', database='management')
    ...
    def delete_data(self):
        ...
        if delete:
            try:
                ...
                self.fetch_data()
                self.clear_data()
                self.root.update_idletasks() # Forcing GUI to update
